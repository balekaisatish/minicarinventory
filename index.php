        ...
        <div id="manufacturer">
            <form action="#" name="mnf">
                ...
                <div class="form-group text-center">
                    <button type="button" class="btn btn-default" onclick="addManufacturere(); clr();">Add</button>
                </div>
            </form>
        </div>
        <div id="model">
            <form id="model-form">
                ...
                <div>
                    <div class="form-group">
                        <label for="model-name"> <span>Model Name:</span>
                        <input type="text" class="form-control input-sm2" id="model-name" required></label>
                   
                        <label for="select-manufacturer"><span>Select Manufacturer:</span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control input-sm" id="model-color" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group text-center">
                    <button type="button" class="btn btn-default" onclick="addModel(); clr();">Save</button>
                </div>
                </div>
            </form>
        </div>
