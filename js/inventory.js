    ...
    $('#inventory-table tbody').on('click', 'tr', function () {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                inventory_details += '<div class="control-group text-center"><img style="max-width:200px; margin: 10px;" src="images/'+ data.image_url_1+'"/><img style="max-width:200px; margin: 10px;" src="images/'+ data.image_url_2+'"/></div>';
